 ...
 */
package com.example.myttpod3.indicator;
...
public class CirclePageIndicator extends View implements PageIndicator {
	...
	public void setmInterval(float mInterval) {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mCentered) {
            longOffset += ((longSize - longPaddingBefore - longPaddingAfter) / 2.0f) - ((count * twoRadius) / 2.0f) - ((count * mInterval) / 2.0f);
