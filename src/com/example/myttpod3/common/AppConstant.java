...
public interface AppConstant {
	public static final String BROADCAST_NAME = "com.example.myttpod3.broadcast";
	public static final String SERVICE_NAME = "com.example.myttpod3.service.MediaService";
	public static final String BROADCAST_QUERY_COMPLETE_NAME = "com.example.myttpod3.querycomplete.broadcast";
	public static final String BROADCAST_CHANGEBG = "com.example.myttpod3.changebg";
	public static final String BROADCAST_SHAKE = "com.example.myttpod3.shake";
	
	//是否开启了振动模式
	public static final String SHAKE_ON_OFF = "SHAKE_ON_OFF";
	
	public static final String SP_NAME = "myttpod3_preference";
